//#region theme/frontend/islands/localization-form.js
var LocalizationForm = class extends window.HTMLElement {
	connectedCallback() {
		...
		this.elements.button.addEventListener("click", this.toggleList.bind(this), { signal });
		this.elements.button.addEventListener("focusout", this.onButtonFocusOut.bind(this), { signal });
		this.elements.list.addEventListener("focusout", this.onListFocusOut.bind(this), { signal });
		this.addEventListener("keyup", this.onLocalizationFormKeyUp.bind(this), { signal });
		for (const item of this.querySelectorAll("a")) item.addEventListener("click", this.onItemClick.bind(this), { signal });
		document.body.addEventListener("click", this.onBodyClick.bind(this), { signal });
	}
